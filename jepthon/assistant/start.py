#    جميع الحقوق لمطوري سورس ايكثون حصريا لهم فقط
...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب ايكثون 🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/BEEEB5")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "https://t.me/icthon1/78")],
                [Button.url("كروب المساعدة ❓", "https://t.me/+EdFMnMz2HVc4YWQ6")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @ICTHONN", alert=True)
