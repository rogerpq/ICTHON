...
from . import jepiq, edit_delete, reply_id
...
@jepiq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}لستة قنواتي الرسمية [𝗧ُِٔ𝗢ٍَِ𝗢َِّ𝗟َٖ𝗦َ]<buttonurl:t.me/ICTHON> [𝗝ََِ𝗠ٓ𝗧َُِْٓ𝗛ُ𝗢َ𝗡ٍَ]<buttonurl:t.me/ICTHON> ",
    },
)
async def _(event):
