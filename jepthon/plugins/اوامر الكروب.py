...
async def ban_user(chat_id, i, rights):
    try:
        await jepiq(functions.channels.EditBannedRequest(chat_id, i, rights))
        return True, None
    except Exception as exc:
        return False, str(exc)

@jepiq.on(admin_cmd(outgoing=True, pattern="تخوني$"))
...
@jepiq.on(admin_cmd(outgoing=True, pattern="مستمرة الكلاوات$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
...
async def event(vois):
    ...
    if jpvois3:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="احبك$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois4:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="اخت التنيج$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois5:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="اذا اكمشك$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois6:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="اسكت$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois7:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="افتهمنا$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois8:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="اكل خرا$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois9:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="العراق$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois10:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="الكعده وياكم$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois11:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="الكمر اني$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois12:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="اللهم لا شماته$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois13:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="اني مااكدر$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois14:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="بقولك ايه$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois15:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="تف على شرفك$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois16:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="شجلبت$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois17:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="شكد شفت ناس$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois18:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="صباح القنادر$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois19:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="ضحكة فيطية$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois20:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="طار القلب$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois21:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="غطيلي$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois22:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="في منتصف الجبهة$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois23:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="لاتقتل المتعه$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois24:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="لا لتغلط$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois25:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="لا يمه لا$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois26:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="لحد يحجي وياي$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois27:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="ماادري يعني$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois28:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="منو انت$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois29:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="مو صوجكم$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois30:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="خوش تسولف$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois31:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="يع$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
...
async def event(vois):
    ...
    if jpvois35:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="يامرحبا$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois36:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="منو انتة$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois37:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="ماتستحي$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois38:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="كعدت الديوث$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois39:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="عيب$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois40:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="عنعانم$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois41:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="طبك مرض$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois42:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="سييي$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois43:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="سبيدر مان$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois44:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="خاف حرام$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois45:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="تحيه لاختك$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois46:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="امشي كحبة$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois47:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="امداك$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois48:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="الحس$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
...
async def event(vois):
    ...
    if jpvois50:
        await vois.client.send_file(vois.chat_id, jpvois32, reply_to=Ti)
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="اطلع برا$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
...
async def event(vois):
    ...
    if jpvois52:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="اوني تشان$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois53:
        ...
        await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="اوني تشان2$"))
async def event(vois):
    if vois.fwd_from:
        return
    Ti = await reply_id(vois)
    if jpvois54:
        ...
        await vois.delete()        
@jepiq.on(events.NewMessage(outgoing=True, pattern="ارسل?(.*)"))
