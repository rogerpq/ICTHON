...
@jepiq.on(admin_cmd(pattern="(بنكي|مصرفي) ?(.*)"))
...
- مثال: .انشاء حساب الرافدين او ايكثون الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "ايكثون الاسلامي":
        bankn = "مصرف ايكثون الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "ايكثون الاسلامي":
